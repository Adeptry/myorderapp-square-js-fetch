...
export interface DeleteCustomerIdRequest {
    id: string;
    xCustomLang?: string;
}
...
export class CustomersApi extends runtime.BaseAPI {
     ...
     */
    async deleteCustomerIdRaw(requestParameters: DeleteCustomerIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling deleteCustomerId.');
        }
        ...
        const response = await this.request({
            path: `/v2/customers/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'DELETE',
     ...
     * Delete Customer with ID
     */
    async deleteCustomerId(requestParameters: DeleteCustomerIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteCustomerIdRaw(requestParameters, initOverrides);
    }
