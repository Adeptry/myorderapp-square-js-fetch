...
export function AppConfigEntityFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppConfigEntity {
    ...
    return {
        ...
        'iconFileSize': !exists(json, 'iconFileSize') ? undefined : json['iconFileSize'],
        'itunesId': !exists(json, 'itunesId') ? undefined : json['itunesId'],
        'itunesUrl': !exists(json, 'itunesUrl') ? undefined : json['itunesUrl'],
        'name': !exists(json, 'name') ? undefined : json['name'],
        'path': !exists(json, 'path') ? undefined : json['path'],
        'playAppId': !exists(json, 'playAppId') ? undefined : json['playAppId'],
        'playAppUrl': !exists(json, 'playAppUrl') ? undefined : json['playAppUrl'],
        'preferRelatedApplications': !exists(json, 'preferRelatedApplications') ? undefined : json['preferRelatedApplications'],
...
export function AppConfigEntityToJSON(value?: AppConfigEntity | null): any {
    ...
    return {
        ...
        'iconFileSize': value.iconFileSize,
        'itunesId': value.itunesId,
        'itunesUrl': value.itunesUrl,
        'name': value.name,
        'path': value.path,
        'playAppId': value.playAppId,
        'playAppUrl': value.playAppUrl,
        'preferRelatedApplications': value.preferRelatedApplications,
